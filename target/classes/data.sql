...
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (5, 'Nick', 'Green', 'nick@mail.com', '$2a$10$ytavNLIzy/FQXR0fBmI2kumC8vi.hx/LUca/5TutUdteLIs1HIe.y', 2);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (6, 'Nora', 'White', 'nora@mail.com', '$2a$10$ytavNLIzy/FQXR0fBmI2kumC8vi.hx/LUca/5TutUdteLIs1HIe.y', 2);
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (4, 'Mike', 'Brown', 'mike@mail.com', '$2a$10$7i/MSsZn1vTWs/NUQRVk5OjbGBUps05NeUjHpx/3SbTHUIYS/GUcu', 1);
